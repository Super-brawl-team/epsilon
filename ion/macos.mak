...
ifeq ($(_ion_simulator_icons_use_mask),1)
	magick -background "#FFB734" MSVG:$< -gravity center -scale 80% -extent 1024x1024 MSVG:$(PATH_ion)/src/simulator/assets/icon_mask.svg -alpha Off -compose CopyOpacity -composite -resize $* $@
else
	magick -background "#FFB734" -resize $* MSVG:$< $@
endif

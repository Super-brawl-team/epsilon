...
void assert_parsed_expression_with_user_parentheses_is(const char* expression,
                                                       Poincare::Expression r) {
...
QUIZ_CASE(poincare_parsing_parse) {
  ...
  assert_parsed_expression_is(
      "((1))", Parenthesis::Builder(
                   (Expression)Parenthesis::Builder(BasedInteger::Builder(1))));
  assert_parsed_expression_is(
      "1+2",
  ...
  Expression::Tuple one_two_three = {BasedInteger::Builder(1),
                                     BasedInteger::Builder(2),
  ...
  assert_parsed_expression_is(
      "--1", Opposite::Builder(
                 (Expression)Opposite::Builder(BasedInteger::Builder(1))));
  assert_parsed_expression_is(
...
QUIZ_CASE(poincare_parsing_matrices) {
  ...
  Expression m2[] = {BasedInteger::Builder(1), BasedInteger::Builder(2),
                     BasedInteger::Builder(3)};
  assert_parsed_expression_is("[[1,2,3]]", BuildMatrix(1, 3, m2));
  Expression m3[] = {BasedInteger::Builder(1), BasedInteger::Builder(2),
...
QUIZ_CASE(poincare_parsing_lists) {
  ...
  {
    Expression elements[] = {BasedInteger::Builder(1), BasedInteger::Builder(2),
                             BasedInteger::Builder(3)};
    assert_parsed_expression_is("{1,2,3}", BuildList(elements));
  }
  {
    Expression inner[] = {BasedInteger::Builder(2), BasedInteger::Builder(3)};
    Expression outer[] = {BasedInteger::Builder(1), BuildList(inner),
                          BasedInteger::Builder(4)};
...
QUIZ_CASE(poincare_parsing_lists_access) {
  ...
  {
    Expression elements[] = {BasedInteger::Builder(3), BasedInteger::Builder(4),
...
QUIZ_CASE(poincare_parsing_implicit_multiplication) {
  ...
  Expression m2[] = {BasedInteger::Builder(2)};

...
class ConstantNode final : public ExpressionNode {
 public:
  ...
  constexpr static const ConstantInfo k_constants[] = {
      ...
      ConstantInfo{"_me", 3, 9.1093837139e-31, "_kg"},
      ConstantInfo{"_mn", 3, 1.67492750056e-27, "_kg"},
      ConstantInfo{"_mp", 3, 1.67262192595e-27, "_kg"},
      ConstantInfo{"_Na", 3, 6.02214076e23, "_mol^-1"},
      ConstantInfo{"_R", 3, 8.31446261815324, "_J*_mol^-1*_K^-1"},
      ConstantInfo{"_ε0", 3, 8.8541878188e-12, "_F/_m"},
      ConstantInfo{"_μ0", 3, 1.25663706127e-6, "_N*_A^-2"},

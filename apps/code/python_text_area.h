...
class PythonTextArea : public Escher::TextArea {
 public:
   ...
   * retreived with autocompletionLocationBeginning and
   * autocompletionLocationEnd. */
  AutocompletionType autocompletionType(
      const char* autocompletionLocation = nullptr,
 ...
 protected:
  class ContentView : public Escher::TextArea::ContentView {
   public:
    ...
    void drawLine(KDContext* ctx, int line, const char* text, size_t length,
                  int fromColumn, int toColumn, const char* selectionStart,
 ...
 private:
  ...
  bool addAutocompletionTextAtIndex(int nextIndex,
                                    int* currentIndexToUpdate = nullptr);

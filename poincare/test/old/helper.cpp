...
void assert_parsed_expression_process_to(
  ...
  Internal::Serializer::Serialize(l, buffer, buffer + bufferSize);
...
void assert_expression_serializes_and_parses_to(
  ...
  Internal::Serializer::Serialize(layout, buffer, buffer + bufferSize);
  layout->removeTree();
...
void assert_expression_parses_and_serializes_to(
  ...
  constexpr int bufferSize = 500;
  char buffer[bufferSize];
  Serializer::Serialize(l, buffer, buffer + bufferSize);
  l->removeTree();

...
class FunctionZoomAndPanCurveViewController
    : public ZoomAndPanCurveViewController {
 public:
  FunctionZoomAndPanCurveViewController(
  ...
  class ContentView : public Escher::View {
   public:
    ...
    constexpr static KDCoordinate k_legendHeight =
        2 * Escher::Metric::BannerTextMargin +
        KDFont::GlyphHeight(k_legendFont);

...
void testPolynomialParsing() {
  ...
  assert_polynomial_is_parsed(
      ...
      /* polynomial */ Pol(exponentsPi, u'π'_n, 1_sn, Pol(exponentsE0, u'e'_n, Mult(3_n, 1_sn, 1_sn)), Pol(exponentsE1, u'e'_n, Mult(3_n, 1_sn, 1_sn)), Pol(exponentsE2, u'e'_n, 1_sn))
    );
  ...
  assert_polynomial_is_parsed(
      ...
      /* polynomial */ Pol(exponentPi, Pow(u'π'_n, 1.2_fn), 1_sn)
    );

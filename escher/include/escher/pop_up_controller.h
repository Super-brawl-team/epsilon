...
class PopUpController : public ViewController {
 public:
  PopUpController(Invocation OkInvocation, Invocation CancelInvocation,
 ...
 protected:
  class ContentView : public View, public Responder {
   public:
    ContentView(Responder* parentResponder, Invocation okInvocation,
                Invocation cancelInvocation, I18n::Message warningMessage,
...
class MessagePopUpController : public PopUpController {
 public:
  MessagePopUpController(Invocation OkInvocation, I18n::Message warningMessage,
                         I18n::Message okMessage, I18n::Message cancelMessage);
...
class MessagePopUpControllerWithCustomCancel : public PopUpController {
 public:
  MessagePopUpControllerWithCustomCancel(Invocation OkInvocation,

...
QUIZ_CASE(pcj_simplification_infinity) {
  ...
  simplifies_to("0^inf", "0");
  simplifies_to("0^(-inf)", "undef");
  // TODO_PCJ: simplifies_to("0.3^inf", "0");
  // TODO_PCJ: simplifies_to("0.3^(-inf)", "undef");
  simplifies_to("1^inf", "undef");
  simplifies_to("1^(-inf)", "undef");
  // TODO_PCJ: simplifies_to("2^inf", "∞");
  // TODO_PCJ: simplifies_to("2^(-inf)", "0");
  simplifies_to("x^inf", "x^∞");
  simplifies_to("inf^0", "undef");
  simplifies_to("inf^x", "e^(∞×sign(x))");
  // TODO_PCJ: simplifies_to("exp(inf)", "∞");
  // TODO_PCJ: simplifies_to("exp(-inf)", "0");
